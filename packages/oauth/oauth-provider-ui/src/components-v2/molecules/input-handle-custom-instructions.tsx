...
/** v2 restyle of `#/components/forms/input-handle-custom-instructions.tsx`. Same DNS/HTTP verification logic. */
  ...
  return (
    <div {...props}>
      ...
      <p className="my-2 flex flex-row flex-wrap gap-3">
        ...
        <LinkExternal href={troubleshootHref}>
          <Trans>Troubleshoot</Trans>
        </LinkExternal>
        <LinkExternal href={mailtoHref} noUtm>
