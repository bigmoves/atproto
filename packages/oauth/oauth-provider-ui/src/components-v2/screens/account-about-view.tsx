      ...
      <div className="prose prose-sm md:prose-base prose-slate dark:prose-invert max-w-none">
        <section>
          <Trans>
            ...
            <p>
              An <strong>Atmosphere account</strong> is your personal identity
              on the Atmosphere. Think of it as a digital passport that you
              truly own, not locked to any single app or company.
            </p>
          </Trans>
        </section>
        ...
        <section>
          <Trans>
            ...
            <p>
              Just like you can use the same email address to sign into
              different websites, your Atmosphere account lets you sign into
              different social apps while keeping the same identity,
        ...
        <section>
          <Trans>
            ...
            <p>
              ...
              platform, with an Atmosphere account you genuinely own your
              identity and data:
            </p>
            <ul>
              <li>
                <strong>You own your identity</strong>: Your username (handle)
                and permanent ID belong to you
              </li>
              <li>
                <strong>Your data is portable</strong>: Posts, follows, and
                content live in your personal data storage, not locked in an
                app's database
              </li>
              <li>
              ...
              <li>
                <strong>Multiple apps, one identity</strong>: Use the same
                account across different apps built on the same network
              </li>
            </ul>
          </Trans>
        </section>
        ...
        <section>
          <Trans>
            ...
            <p>
              ...
              Atmosphere identity, independently of any app-specific details
            ...
            <p>
              Your Atmosphere account is currently hosted by{' '}
              <CustomizationName />, one of many hosting providers in the
              Atmosphere network. You can switch to a different one at any time
              without losing your account, identity, or data.
            </p>
          </Trans>
        </section>
