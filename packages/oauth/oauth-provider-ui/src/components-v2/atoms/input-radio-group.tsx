        ...
        return (
          <label
            ...
            className={clsx(
              ...
              'has-[:focus-visible]:ring-ink has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-offset-1 has-[:focus-visible]:ring-offset-white dark:has-[:focus-visible]:ring-offset-black',
              option.disabled
                ? 'text-ink-light cursor-not-allowed opacity-60'
                : 'cursor-pointer',
              checked
                ? 'bg-surface-2 text-ink border-ink'
                : 'text-ink-light hover:bg-surface-2',
            )}
          >
            <input
              type="radio"
            ...
            <span className="flex flex-col gap-0.5">
              ...
              {option.description && (
                <span
                  id={descriptionId}
                  className="text-ink-light leading-snug"
                >
                  {option.description}
                </span>
              )}
